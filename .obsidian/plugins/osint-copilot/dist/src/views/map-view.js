 ...
 */
import { ItemView, Notice, Modal, Menu } from 'obsidian';
import { EntityType, ENTITY_CONFIGS } from '../entities/types';
...
export class MapView extends ItemView {
     ...
     */
    openLocationCreator() {
        const modal = new EntityCreationModal(this.app, this.entityManager, EntityType.Location, (entityId) => {
        ...
        marker.on('contextmenu', (e) => {
            ...
            menu.addItem((item) => {
                item
                    ...
                    if (entity) {
                        new EntityCreationModal(this.app, this.entityManager, entity.type, () => {
                            this.refresh();
                        }, entity.properties, entity.id).open();
                    }
                    else {
     ...
     */
    async showGeolocateMissingDialog() {
        ...
        const modal = new GeolocateMissingModal(this.app, locationsWithoutCoords, this.geocodingService, this.entityManager, async () => {
...
class GeolocateMissingModal extends Modal {
    constructor(app, locations, geocodingService, entityManager, onComplete) {
        super(app);
