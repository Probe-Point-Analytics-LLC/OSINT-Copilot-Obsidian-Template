 ...
 */
import { ftmSchemaService } from '../services/ftm-schema-service';
...
export const FTM_RELATIONSHIP_TYPES = [
    'Ownership',
    'Employment',
    'Directorship',
];
 ...
 */
export function getFTMEntityConfig(schemaName) {
 ...
 */
export function getEntityLabel(type, properties) {
 ...
 */
export function isFTMSchema(type) {
 ...
 */
export function validateEntityName(name, entityType) {
    // Trim whitespace
 ...
 */
export const LEGACY_TO_FTM_MAP = {
    [EntityType.Person]: 'Person',
    [EntityType.Event]: 'Event',
 ...
 */
export function legacyToFTMSchema(type) {
